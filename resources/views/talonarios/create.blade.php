...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
        <h5 class="card-title">crear nuevo Talonarios</h5>
           <form class="row g-3" id="submitForm" method="POST"  action="{{ url('talonarios/guardar-talonario') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- Columna Izquierda -->
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control" id="imageUrl" name="imageUrl" placeholder="https://ejemplo.com/imagen.jpg" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="numbers" name="numbers" step="0.01" min="0" max="99999" required>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <p style="color: #717171; font-weigh:bold; text-align:center; margin-top:50px;">Agregar Galeria</p>
                  <hr>
                <div id="allGallery">
...
$(document).ready(function(){
  ...
  $("#submitForm").on("submit", function () {
   ...
   $("#addGallery").on("click", function (e) {
      ...
      $("#allGallery").append('<div class="row mt-5" id="img_'+countDiv+'"><div class="col-10"><input type="file" class="form-control" placeholder="imagen"  name="imgGallery_'+countDiv+'" required></div><div class="col-2"><p class="btn waves-effect waves-light btn-sm btn-info" onclick="borrar('+countDiv+')" value="img_2" ><i class="bi bi-dash h3" style="color: #ffff;"></i></p></div></div>');
