        ...
        <div class="card-body">
          ...
          <table class="table datatable">
            <thead>
              <tr>
                  <th width="5px">#</th>
                  <th width="500px">Provincias</th>
                  <th width="500px">pais</th>
                  <th width="500px">Bandera</th>
                  <th>Acciones</th>
              </tr>
            </thead>
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>{{ $item->pais }}</td>
                        <td><img src="{{ $item->flag }}" width="25px"></td>
                        <td>
                            <!-- Editar Categoria -->
                            <a href="{{ url('provincias/' . $item->id . '/editar-provincia') }}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <form method="POST"
                                                action="{{ url('provincias/' . $item->id . '/borrar-provincia') }}">
                                                @method('DELETE')
                                                @csrf
